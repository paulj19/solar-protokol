...
export const handlers = [
    rest.get(URL_GENERAL_PARAMS, (req, res, ctx) => {
        return res(ctx.json({ rent: 132, rentDiscountPeriod: 2, rentDiscountRate: 11.36, feedInPrice: 0.08, inflationRate: 3, electricityIncreaseRate: 1, yearLimit: 25 }), ctx.status(200));
    }),
